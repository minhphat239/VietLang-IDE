...
public static class TestMath
{
    ...
    {
        new LexTest { Name = "math_can_bac_hai", Run = () => Eq(ChayMath("can_bac_hai(9)"), 3.0) },
        new LexTest { Name = "math_tuyet_doi", Run = () => Eq(ChayMath("tuyet_doi(-5)"), 5.0) },
        new LexTest { Name = "math_toi_da", Run = () => Eq(ChayMath("toi_da(3, 7)"), 7.0) },
        new LexTest { Name = "math_toi_thieu", Run = () => Eq(ChayMath("toi_thieu(3, 7)"), 3.0) },
        ...
        new LexTest { Name = "math_lam_tron", Run = () => Eq(ChayMath("lam_tron(1.5)"), 2.0) },
        new LexTest { Name = "math_lam_nguyen", Run = () => Eq(ChayMath("lam_nguyen(1.7)"), 1.0) },
